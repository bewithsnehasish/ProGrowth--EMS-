...
-- CreateEnum
CREATE TYPE "DocumentType" AS ENUM ('EDUCATIONAL', 'EXPERIENCE', 'TERMS_ACCEPTANCE');

-- CreateEnum
CREATE TYPE "DocumentStatus" AS ENUM ('SUBMITTED', 'APPROVED', 'REJECTED');

-- CreateEnum
CREATE TYPE "TaskStatus" AS ENUM ('ASSIGNED', 'WORKING', 'COMPLETED', 'OVERDUE', 'NOT_COMPLETED');
